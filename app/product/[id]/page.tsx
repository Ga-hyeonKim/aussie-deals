      ...
      <div className="mx-auto max-w-lg px-4 py-6">
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-2xl border border-gray-200 bg-white p-5">
            ...
            {storeProduct
              ? <PriceHistoryChart storeProductId={storeProduct.id} currentPrice={product.salePrice} />
              : <p className="text-xs text-gray-400">No history yet — check back after the next weekly update.</p>
            }
          </div>
